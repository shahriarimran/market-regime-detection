...
PER_CLASS_FILE = (
    OUTPUT_DIR
    / "logistic_regression_per_class.csv"
)
...
def present_class_balanced_accuracy(
    ...
    """
    Mean recall across classes that actually
    exist in the current test fold.

    Avoids misleading warnings when DOWN
    is absent from years such as 2025/2026.
    """
...
def main():
    ...
    print(
        "POOLED OUT-OF-SAMPLE LOGISTIC RESULTS"
    )
    ...
    # ========================================================
    # Compare against M3 momentum hurdle
    # ========================================================
    ...
    print(
        "Pooled Balanced Accuracy: 50.06%"
    )

    print(
        "Pooled Macro F1:          50.03%"
    )
